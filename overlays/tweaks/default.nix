...
self: super: {
  ...
  #
  # When spectacle updates to >= 6.6.4: patches 4 and 5 are already
  # upstream (CaptureOverlay rewritten with proper bounds,
  # ImagePlatformKWin cancel fix merged). Patch 1's target
  # (AnnotationDocument.cpp) moved to kquickimageeditor; the fix needs
  # to go in SpectacleCore instead (add ImageMetaData include + translate
  # canvasRect by logicalXY in initCaptureWindows). See git history
  # (commit a45afe3) for 6.6.4-compatible 2-patch versions.
