...
__host() {
  if [[ -n $SSH_CONNECTION ]]; then
    ...
    echo -n "%{$fg_bold[green]%}$(hostname)%{$reset_color%}"
    echo -n "%{$fg_bold[grey]%}:%{$reset_color%}"
...
INSERT_MODE="%{$fg_bold[green]%}$__INSERT_MODE_SYMBOL%{$reset_color%}"
NORMAL_MODE="%{$fg_bold[red]%}$__NORMAL_MODE_SYMBOL%{$reset_color%}"
