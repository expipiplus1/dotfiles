...

{
  ...
  users.users.e = {
    ...
    shell = pkgs.zsh;
    extraGroups = [ "wheel" "bluetooth" "vboxusers" "dialout" "networkmanager" ];
    subUidRanges = [{ startUid = 100000; count = 65536; }];
    subGidRanges = [{ startGid = 100000; count = 65536; }];
    hashedPassword = "$6$leXV9Uwdw1JP5z$yCxKu/YvrhT7iqGgGU//sv4RYOp6zC797nlRWmSM9L0Fy3GYN94i4QoY8k8jJ9He1PGfeXp4vtX006INgXMY/1";
